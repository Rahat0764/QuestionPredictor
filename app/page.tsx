      ...
      <section className="text-center pt-12 pb-8">
        ...
        <div className="flex justify-center gap-10 mb-10 flex-wrap">
          <div className="text-center">
            ...
            <div style={{ fontSize: 12, color: "var(--text-muted)", fontWeight: 500, letterSpacing: 0.5, marginTop: 2 }}>
              Subjects
            </div>
          </div>
          <div className="text-center">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          <Link
            ...
            className="btn-ghost-muted px-8 py-3.5 text-sm no-underline inline-flex items-center gap-2"
          >
            📤 Upload Papers
          </Link>
        </div>
        ...
        {[
          {
            ...
            desc: "Scan past exam papers. AI-powered OCR supports English & Bengali text with automatic extraction.",
            color: "blue",
            iconBg: "rgba(99,102,241,0.15)",
            iconBorder: "rgba(99,102,241,0.3)",
            gradient: "radial-gradient(circle at 30% 30%, rgba(99,102,241,0.12), transparent 70%)",
          },
          {
            href: "/upload/resources",
            icon: "📚",
            title: "Upload Resources",
            desc: "Add textbooks, notes, and supplements as PDF or images. Deepens the AI's understanding.",
            color: "violet",
            iconBg: "rgba(139,92,246,0.15)",
            iconBorder: "rgba(139,92,246,0.3)",
            gradient: "radial-gradient(circle at 30% 30%, rgba(139,92,246,0.12), transparent 70%)",
          },
          {
            href: "/predict",
            icon: "🔮",
            title: "Get Predictions",
            desc: "AI detects recurring patterns, topic frequency, and co-occurrence to forecast probable questions.",
            color: "pink",
            iconBg: "rgba(236,72,153,0.15)",
            iconBorder: "rgba(236,72,153,0.3)",
            gradient: "radial-gradient(circle at 30% 30%, rgba(236,72,153,0.12), transparent 70%)",
          },
        ].map(card => (
          <Link
            key={card.title}
            href={card.href}
            className="glass-card group relative overflow-hidden text-left no-underline block"
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <span
                ...
                className="group-hover:translate-x-[3px] group-hover:-translate-y-[3px] group-hover:text-[var(--violet-light)]"
              >
                ↗
              </span>
            </div>
